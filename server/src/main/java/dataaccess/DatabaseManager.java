...
public class DatabaseManager {
    ...
    public static void configureDatabase() throws DataAccessException {
        ...
        var gameStatement = "CREATE TABLE IF NOT EXISTS Game (`gameID` int NOT NULL, whiteUsername varchar(255), blackUsername varchar(255), gameName varchar(255), game text, PRIMARY KEY (gameID))";
